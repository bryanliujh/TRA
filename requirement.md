...
1. Please use NodeJS for the backend code.
1. Please use MySQL as the database.
1. Please include unit tests.
1. If you are selected for a face-to-face interview, you should be prepared to:
